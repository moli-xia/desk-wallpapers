...
class WallpaperApp:
    ...
    def set_window_icon(self, window):
        ...
        try:
            ...
            if os.path.exists("app_icon.ico"):
                ...
                print("成功设置图标: app_icon.ico")
                return
            
            # 尝试使用resource_path查找图标
            ...
            # 如果ico文件不存在，尝试使用PNG格式
            try:
                from PIL import Image, ImageTk
                if os.path.exists("app_icon.svg"):
                    # 创建一个简单的PNG图标作为备用
    ...
    def setup_ui(self):
        ...
        # 软件名称和版本
        ttk.Label(about_frame, text="壁纸屏保下载器 v2.1.4", font=("Helvetica", 10), bootstyle=PRIMARY).pack()
    ...
    def get_high_res_image(self):
        try: return requests.get("https://picsum.photos/3840/2160", timeout=20).content
